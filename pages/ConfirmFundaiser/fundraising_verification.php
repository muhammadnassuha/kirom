		...
		<form action="index.php?page=ProsessFundaiserVerification" method="post" enctype="multipart/form-data">
			<div class="container">
				<div class="row">
						...
						<div class="card mb-3 mt-3" style="padding: 20px; width: 100%">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" name="nama"aria-label="Username" aria-describedby="basic-addon1" required="" 
								placeholder="Masukan Nama Lengkap"  style="border-radius: 5px;">
							</div>

							<div class="mb-3">
								<label for="exampleInputEmail1" class="form-label">Tanggal Verifikasi*</label>
								<input type="date" class="form-control" id="exampleInputEmail1" name="date" aria-describedby="emailHelp" placeholder="Masukan Tanggal Verifikasi" required=""> 
							</div>
