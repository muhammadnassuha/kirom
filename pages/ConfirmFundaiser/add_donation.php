		...
		<div class="row">
			<div class="col-md-12">
				<div class="card mt-5  " style=" width: 100%; padding: 50px;">
					...
					<label>Nama :</label>
					<input type="text" name="nama" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" oninvalid="this.setCustomValidity('Masukkan Nama Anda')" oninput="setCustomValidity('')">
					<label>No Hp :</label>
					<input type="text" name="wa" id="telp_number" class="form-control" placeholder="Nomor HP" maxlength="13">
					<label>Nominal</label>
					<input type="text" name="jumlah" id="rupiah" class="form-control" placeholder="Jumlah Nominal" aria-label="Username" aria-describedby="basic-addon1" required="" oninvalid="this.setCustomValidity('Masukkan Donasi Anda')" oninput="setCustomValidity('')">
						...
						<div class="card-header" id="headingThree">
							<label for="bni-bank">
								<div class="row">
									<div class="">
										<div class="radio-bni">
											<input type="radio" name="radios" id="radio-btn" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" value="bni" class="mr-2" id="bni-bank" style="margin-top: 40px"></div>
											<img src="assets/images/bni.jpg" style="width: 4em; margin-left: 25px; margin-top: -50px">
										</div>
										<div class="col-9">
											<p class="nama-bank" style="margin-left: 33px; font-size: 14px">
												<b> 0632413704</b><br>
												<span>a/n : Yayasan Alkirom Amanah</span>
												<br>Cabang : Cinere</p>
											</div>
								...
								<div class="card mb-5"style="width: 100%;">
									<div class="card-header" id="headingTwo">
										<label for="cimb-bank">
											<div class="row">
												<div class="col-3">
													<div class="radio-cimb">
														<input type="radio" name="radios" id="radio-btn" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" value="cimb" class="mr-2" id="cimb-bank" style="margin-top: 35px"></div>
														<img src="assets/images/cimb.jpg" style="width: 6em; margin-left: 25px; margin-top: -50px;">
													</div>
													<div class="col-9">
														<p class="nama-bank" style="margin-left: 33px; font-size: 14px">
															<b>8001 6831 2900</b><br>
															<span>a/n : Yayasan Alkirom Amanah</span>
															<br>Cabang : Cinere</p>
														</div>
													</div>
