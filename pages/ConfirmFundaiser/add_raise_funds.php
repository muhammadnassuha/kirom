	...
	<div class="container">
		<div class="row">
			<div class="col-md-6 mb-3 mt-3 ">
				...
				<div class="col-md-6 mb-3 mt-3">	
				<div class="card" style="margin-left: -30px; width: 100%;height: 720px;">
					<h1 class="mt-3" style="font-weight: bold; text-align: center;">Buat Galang Dana Anda sendiri</h1>
					<h5 style=" text-align: center;">Masukan Informasi Yang Lengkap Dan Akurat!</h5>
