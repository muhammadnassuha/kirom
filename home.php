            ...
            <div class="table">
                <div class="row campaign-table">
                    <?php 
                     ...
                     $query_mysqli = mysqli_query($conn, "SELECT SUM(id) as id FROM galang_dana");
                    ...
                    <div class="col-4">
                        <span class="nilai"><?php echo $query['id']; ?></span> <br><span class="keterangan"> campaign</span>
                    </div>
                <?php }?>
                    ...
                    ?>
                    <div class="col-4">
                    <span class="nilai"><?php echo $query['jumlah_donasi']; ?></span> <br><span class="keterangan"> Donasi Terkumpul</span>
                    </div>
                <?php } ?>

                 <?php 
                     include "config/connection.php";
                     $query_mysqli = mysqli_query($conn, "SELECT SUM(id) as id FROM donasi");

                     while ($query = mysqli_fetch_array($query_mysqli)) {
                     
                    ?>
                    <div class="col-4">
                        <span class="nilai"><?php echo $query['id']; ?></span> <br><span class="keterangan"> Donatur</span>
                    </div>
                <?php } ?>
                </div> 
            </div>
